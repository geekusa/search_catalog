...
### Release Notes
Minor fix to welcome screen. Added most\_populated\_filter.csv to act as place to drop in fields to not include in the Most Populated Fields panel. Fixed opening result count.
